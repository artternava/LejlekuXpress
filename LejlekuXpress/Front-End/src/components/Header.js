...
// const handleLogin = () => {
  //   // authenticate user and set the isLoggedIn state to true
  //   setIsLoggedIn(true);
  //   Cookies.set("auth_token", "my_auth_token"); // replace "my_auth_token" with the actual token
  // };
  // const handleLogout = () => {
  //   // remove user authentication token and set the isLoggedIn state to false
